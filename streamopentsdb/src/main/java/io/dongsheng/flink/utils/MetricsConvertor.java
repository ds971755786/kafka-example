...
//        DISK_MAJOR.put(253l, "alibaba");
    ...
    public static List<Metric> convertor(ContainerInfo containerInfo, String token) {
//        String namespace;
//        String podName;
//        String appName;
...
//        tagsMap.put(OpentsdbMetricsConst.TOKEN, token);
    ...
    private static List<Metric> convertorGpu(long dateTimeLong, GpuStats[] gpuStats, Map<String, String> tagsMap) {
    ...
    private static List<Metric> convertorCpu(long dateTimeLong, CpuStats cpuStats, Map<String, String> tagsMap) {
        Metric opentsdbMetrics = null;
